    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <nav className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            className="bg-slate-100 text-slate-500 font-medium text-sm px-4 py-2 
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-2xl shadow-md w-full max-w-lg p-8">
          ...
          <p className="text-slate-500 text-sm mb-8">
            Join MediCore HMS to securely manage your medical records and
            appointments.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Full Name */}
            <div>
              <label className="flex items-center gap-1.5 text-sm font-medium text-slate-800 mb-1.5">
                <svg
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Email */}
              <div>
                <label className="flex items-center gap-1.5 text-sm font-medium mb-1.5 text-slate-500 ">
                  <svg
                    className="w-4 h-4 text-[#64748B]"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              {/* Phone */}
              <div>
                <label className="flex items-center gap-1.5 text-sm font-medium text-slate-500 mb-1.5">
                  <svg
                    className="w-4 h-4 text-[#64748B]"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            {/* Password */}
            <div>
              <label className="flex items-center gap-1.5 test-sm font-medium text-[#1E293B] mb-1.5">
                <svg
                  className="w-4 h-4 text-[#64748B]"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            {/*Confirm Password */}
            <div>
              <label className="text-slate-800 flex items-center gap-1.5 text-sm font-medium mb-1.5">
                <svg
                  className="w-4 h-4 text-[#64748B]"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          duration-200 text-sm disabled:opacity-60 disabled:cursor-not-allowed
        ...
        {/* Footer */}
        <div className="mt-8 text-center text-xs text-[#94A3B8] space-y-1 pb-8">
          <p>@ 2026 MediCore HMS.
            All rights reserved.
          </p>
          <p className="flex items-center justify-center gap-3">
            ...
            <span>•</span>
            <span className="hover:text-[#64748B] cursor-pointer">Security</span>
            <span>•</span>
            <span className="hover:text-[#64748B] cursor-pointer">Contact</span>
          </p>
        </div>
      </div>
    </div>
